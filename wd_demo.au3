...
Func DemoFrames()
	...
	Local Const $sArrayHeader = 'Absolute Identifiers > _WD_FrameEnter|Relative Identifiers > _WD_FrameEnter|IFRAME/FRAME attributes|URL|Body ElementID|IsHidden|MatchedElements'
